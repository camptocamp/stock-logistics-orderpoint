...
from .common import OrderpointSafetyStockCommonSimpleMath


class TestStockOrderpointSafetyStock(OrderpointSafetyStockCommonSimpleMath):
    ...
    def test_growth_factor(self):
        """Test that a non-zero growth_factor scales the safety stock correctly.
